...
def lowhang():
                ...
                def lacofemailconfer():
                    top=Toplevel(root)
                    top.geometry("750x750")
                    top.title("Lack of email confermation ")
                    a=Label(top,text='''Step to reproduce :-
                    If we create a account on a website and it do't send 
                    any confermation email then its a bug 
                ...
                chbt=Checkbutton(root,text="Lack of email confermation                                   ",bg="black",fg="red",font=('arial',16,'bold'))
                chbt.place(x=700,y=180)
                chbt=Button(root,text="Help",command=lacofemailconfer)
                chbt.pack()
                chbt.place(x=1200,y=180)
...
def Goodbug():
                ...
                def xssviasvg():
                    top=Toplevel(usr2)
                    top.geometry("750x750")
                    top.title("How to exploit svg ")
                    a=Label(top,text='''Svg is a file type if we upload a svg file in the upload parameter the file has alert payload in 
                    it then we click on open in new tab then it should show a popup''',font=('arial',16,'bold'))
                    a.pack() 
                def xssfileneame():
                    top=Toplevel(usr2)
                    top.geometry("750x750")
                    top.title("How to exploit xssfilename ")
                    a=Label(top,text='''When evere we upload a file it has a name just put the xss pyaload in the file name 
                ''',font=('arial',16,'bold'))
                    a.pack()  
                def longstringdos():
                    top=Toplevel(usr2)
                    top.geometry("750x750")
                    top.title("How to exploit Longstringdos ")
                    a=Label(top,text='''When we upload the file then make the name of the file so 
                    large that server can't handle it''',font=('arial',16,'bold'))
                    a.pack()
                def largefildosattack():
                    top=Toplevel(usr2)
                    top.geometry("750x750")
                    top.title("How to exploit large file dos attack;- ")
                    a=Label(top,text='''Upload a very big size file it will lead to dos''',font=('arial',16,'bold'))
                    a.pack()
                def Insecurestorge():
                    top=Toplevel(usr2)
                    top.geometry("750x750")
                    top.title("How to exploit Insecure storge ")
                ...
                chbt=Checkbutton(usr2,text="Xss via SVG                                                                     ",bg="black",fg="red",font=('arial',16,'bold'))
                chbt.place(x=5,y=460)
                chbt=Button(usr2,text="Help",command=xssviasvg)
                chbt.pack()
                chbt.place(x=600,y=460)

                chbt=Checkbutton(usr2,text="Xss Filename                                                                   ",bg="black",fg="red",font=('arial',16,'bold'))
                chbt.place(x=5,y=500)
                chbt=Button(usr2,text="Help",command=xssfileneame)
                chbt.pack()
                chbt.place(x=600,y=500) 

                chbt=Checkbutton(usr2,text="Long string dos                                                               ",bg="black",fg="red",font=('arial',16,'bold'))
                chbt.place(x=5,y=540)
                chbt=Button(usr2,text="Help",command=longstringdos)
                chbt.pack()
                chbt.place(x=600,y=540)

                chbt=Checkbutton(usr2,text="Lare file dos attack                                                         ",bg="black",fg="red",font=('arial',16,'bold'))
                chbt.place(x=5,y=580)
                chbt=Button(usr2,text="Help",command=largefildosattack)
                chbt.pack()
                chbt.place(x=600,y=580)

                chbt=Checkbutton(usr2,text="Insecure storge                                                               ",bg="black",fg="red",font=('arial',16,'bold'))
                chbt.place(x=5,y=620)
